...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_pawn = [
        ...
        // Should the transcript /bees command belong to DreamWorks
    (BonziData.event_list_bees = [
        { type: "text", text: "According to all known laws" },
        { type: "text", text: "of aviation," },
        { type: "text", text: "there is no that way a bee" },
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "dark_green", "dark_purple", "dark_red", "diamond", "emerald", "god", "gold", "green", "indigo", "magenta", "oldgod", "orange", "peedy_pope", "pink", "pink2", "purple", "rainbow", "rainbow_pope", "red", "red_pink", "teal", "yellow", "pope", "dunce", "pope2", "zander", "clippy", "genie", "max", "merlin", "peedy", "program", "robby"], b = 0; b < a.length; b++) {
                        var c = a[b],
