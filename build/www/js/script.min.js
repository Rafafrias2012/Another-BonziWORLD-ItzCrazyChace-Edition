...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziDark_green", src: "./img/bonzi/dark_green.png" },
        ...
        { id: "bonziPink2", src: "./img/bonzi/pink2.png" },
        { id: "bonziPurple", src: "./img/bonzi/purple.png" },
        { id: "bonziRainbow", src: "./img/bonzi/rainbow.png" },
        { id: "bonziRed", src: "./img/bonzi/red.png" },
        { id: "bonziRed_pink", src: "./img/bonzi/red_pink.png" },
        { id: "bonziTeal", src: "./img/bonzi/teal.png" },
...
function errorFatal() {
    ("none" != $("#page_ban").css("display") && "none" != $("#page_kick").css("display")) || $("#page_error").show();
      ...
      function setup() {
	    ...
	    var sfx = new Audio("./ab_logon.wav");
	    sfx.play();
        ...
        socket.on("serverdata", a=>{
            $("#memcount").html("User Count: "+a.count)
        }),
...
var _createClass = (function () {
    ...
    Bonzi = (function () {
		...
		setTimeout(function(){	
	    var sfx = new Audio("./jump_off.mp3");
	    sfx.play();
		}, 1600);
        }
        return (
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
                            this.$dialogCont.html("<img height='270' src='" + a + "'></img>"), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
                            this.$dialogCont.html("<iframe width='480' height='270' src='" + a + "'></iframe>"), this.$dialog.show();
                        }
                    },
                },
            {
                ...
                },
                {
                    key: "shrug",
                    value: function () {
                        var a = [{ type: "anim", anim: "shrug_fwd", ticks: 15 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "greet",
                    value: function () {
                        var a = [{ type: "anim", anim: "greet_fwd", ticks: 15 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "swag",
                    value: function () {
                        var a = [{ type: "anim", anim: "cool_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "grin",
                    value: function () {
                        var a = [{ type: "anim", anim: "grin_fwd", ticks: 15 }];
                        this.runSingleEvent(a);
                    },
                },
            {
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_bees = [
        ...
        { type: "text", text: "there is no way that a bee" },
        ...
        { type: "text", text: "You are in a coma. This is our only way to communicate. Please wake up." },
                  ...
                  $(document).ready(function () {
                    ...
                    for (var a = ["black", "blue", "brown", "dark_green", "dark_purple", "dark_red", "diamond", "emerald", "god", "gold", "green", "indigo", "magenta", "oldgod", "orange", "peedy_pope", "pink", "pink2", "purple", "rainbow", "rainbow_pope", "red", "red_pink", "seamus", "teal", "yellow", "pope", "dunce", "pope2", "zander", "clippy", "diogo", "genie", "max", "merlin", "peedy", "program", "robby"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziDark_green", "bonziDark_purple", "bonziDark_red", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziIndigo", "bonziMagenta", "bonziOrange", "bonziPink", "bonziPink2", "bonziPurple", "bonziRainbow", "bonziRed", "bonziRed_pink", "bonziTeal", "bonziYellow", "clippy", "diogo", "genie", "merlin", "peedy", "program", "robby", "topjej"];
...
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("ban", function (a) {
            (sfx = new Audio("ban.wav")), sfx.play(), $("#page_ban").show(), $("#ban_reason").html(a.reason), $("#ban_end").html(new Date(a.end).toString());
        }),
        socket.on("kick", function (a, p) {
            (sfx = new Audio("./kick.wav")), sfx.play(), $("#page_kick").show(), $("#kick_reason").html(a.reason);
        }),
