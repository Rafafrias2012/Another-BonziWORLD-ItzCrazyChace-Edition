        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "dark_green", "dark_purple", "dark_red", "diamond", "emerald", "god", "gold", "green", "indigo", "magenta", "oldgod", "orange", "peedy_pope", "pink", "pink2", "purple", "rainbow", "rainbow_pope", "red", "red_pink", "teal", "yellow", "pope", "pope2", "zander", "clippy", "genie", "max", "merlin", "peedy", "program", "robby"], b = 0; b < a.length; b++) {
                        var c = a[b],
